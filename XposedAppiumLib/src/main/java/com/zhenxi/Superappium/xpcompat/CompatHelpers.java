...
public class CompatHelpers {
    ...
    private static Field findFieldRecursiveImpl(Class<?> clazz, String fieldName) throws NoSuchFieldException {
        try {
            ...
            return FreeReflection.getDeclaredField(clazz, fieldName);
        } catch (NoSuchFieldException e) {
    ...
    public static void findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        if (parameterTypesAndCallback.length == 0 || !(parameterTypesAndCallback[parameterTypesAndCallback.length - 1] instanceof CompatMethodHook))
            throw new IllegalArgumentException("no callback defined");

        CompatMethodHook callback = (CompatMethodHook) parameterTypesAndCallback[parameterTypesAndCallback.length - 1];
        Method m = findMethodExact(clazz, methodName, getParameterClasses(clazz.getClassLoader(), parameterTypesAndCallback));

        XpCompatEngine.hookMethod(m, callback);
    }

    public static void findAndHookMethodSafe(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        try {
            findAndHookMethod(clazz, methodName, parameterTypesAndCallback);
        } catch (Throwable throwable) {
            Log.w("RATEL", "findAndHookMethodSafe exception", throwable);
     ...
     * {@link XpCompatEngine#hookMethod}.
     *
    ...
    public static Method findMethodExact(Class<?> clazz, String methodName, Class<?>... parameterTypes) {
        ...
        try {
            ...
            Method method = FreeReflection.getDeclaredMethod(clazz, methodName, parameterTypes);
    ...
    private static Class<?>[] getParameterClasses(ClassLoader classLoader, Object[] parameterTypesAndCallback) {
        ...
        for (int i = parameterTypesAndCallback.length - 1; i >= 0; i--) {
            ...
            if (type instanceof CompatMethodHook)
                continue;
    ...
    public static Constructor<?> findConstructorExact(Class<?> clazz, Class<?>... parameterTypes) {
        ...
        try {
            ...
            Constructor<?> constructor = FreeReflection.getDeclaredConstructor(clazz, parameterTypes);
    ...
    public static void findAndHookConstructor(Class<?> clazz, Object... parameterTypesAndCallback) {
        ...
        XpCompatEngine.getsHookProvider().hookMethod(m, callback);
    }
