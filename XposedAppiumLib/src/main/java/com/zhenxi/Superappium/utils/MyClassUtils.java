...
public class MyClassUtils {
    ...
    public static Class<?> getClass(String className, boolean initialize) throws ClassNotFoundException {
        ...
        ClassLoader loader = contextCL == null ? MyClassUtils.class.getClassLoader() : contextCL;
    ...
    public static String getShortCanonicalName(String canonicalName) {
        return MyClassUtils.getShortClassName(getCanonicalName(canonicalName));
    }
    ...
    public static String getPackageCanonicalName(String canonicalName) {
        return MyClassUtils.getPackageName(getCanonicalName(canonicalName));
    }
